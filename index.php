...
<img class="banner" src="./img/baner.png" alt="">
<H2 class="proHeading" style="margin-bottom:20px"><u>All Products</u></H2>
...
FROM product p
LEFT JOIN subcategory s ON p.subCat_id = s.subCat_id WHERE `status` = 'available'";
    ...
    <div class="ProDetails">
        ...
        <div class="flex-item"><span><b>Rs.</b></span><b>'.$row["pro_price"].'</b></div><div class="flex-item"><a style="color:red;" href="index.php?add-to-cart='.$row["pro_id"].'"><u>Add to Cart</u></a></div>
