...
<H2 class="proHeading" style="margin-bottom:10px"><u>Women Casual</u></H2>
...
FROM product p
LEFT JOIN subcategory s ON p.subCat_id = s.subCat_id WHERE subCat_name = 'casual(women)' AND `status` = 'available'";
    ...
    <div class="ProDetails">
        ...
        <div class="flex-item"><span><b>Rs.</b></span><b>'.$row["pro_price"].'</b></div><div class="flex-item"><a style="color:red;" href="womenCasual.php?add-to-cart='.$row["pro_id"].'"><u>Add to Cart</u></a></div>
